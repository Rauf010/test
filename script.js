...
const hintWords = {
    ...
    randoms: ['Woord', 'Uitdrukking', 'Term', 'Slang', 'Dialect'],
...
const database = {
    games: [
     ...
     'Grand Theft Auto VI', 'EA Sports FC', 'Counter-Strike 2', 'Marvel Rivals', 'Baldurs Gate 3',
'Diablo IV', 'Starfield', 'Monster Hunter World', 'The Last of Us', 'Uncharted',
'Cyberpunk 2077', 'Forza Horizon', 'Gran Turismo', 'Need for Speed', 'The Crew Motorfest',
'Dragon Ball FighterZ', 'Naruto Ultimate Ninja Storm', 'Super Smash Bros', 'Clash Royale', 'Clash of Clans',
'Genshin Impact', 'Honkai Star Rail', 'Roblox Doors', 'Five Nights at Freddys', 'Phasmophobia',
'Dead by Daylight', 'Resident Evil 4', 'Silent Hill 2', 'The Division 2', 'Borderlands',
'Doom', 'Assassins Creed Mirage', 'Far Cry 6', 'Watch Dogs Legion', 'Metal Gear Solid',
'Hitman 3', 'Mafia', 'Monopoly', 'Risk', 'Among Us 2'
    ],
    sport: [
    ...
    randoms: [
    'Bro', 'Bruh', 'Lil Bro', 'Big Bro', 'Gang',
    'Twin', 'Chat', 'NPC', 'Main Character', 'Side Quest',
    'Delulu', 'Aura', 'Rizz', 'Unspoken Rizz', 'Negative Rizz',
    'Cooked', 'We Cooked', 'Its Giving', 'Core', 'Energy',
    'Glaze', 'Glazing', 'Meatriding', 'Crash Out', 'Tweaking',
    'Standing On Business', 'Locked In', 'Tapped In', 'Motion', 'Motionless',
    'W', 'Big W', 'L', 'Big L', 'Common W',
    'Common L', 'Rare W', 'Skill Issue', 'Hardstuck', 'Sweaty',
    'Tryhard', 'Touch Grass', 'Get Good', 'Mid', 'Mid Diff',
    'Low Diff', 'High Diff', 'Zero Diff', 'Blud', 'Yap',
    'Yapping', 'Yapper', 'Fax', 'No Cap', 'Cap',
    'On God', 'Fr', 'Frfr', 'Bet', 'Say Less',
    'Its Peak', 'Peak', 'Down Bad', 'Wild', 'Crazy',
    'Unhinged', 'Diabolical', 'Menace', 'Villain Arc', 'Plot Twist',
    'Lore', 'Canon Event', 'POV', 'Core Memory', 'Brainrot',
    'Cook', 'Let Him Cook', 'Weird Flex', 'Subtle Flex', 'Flex',
    'Bodied', 'Cleared', 'Diffed', 'Carried', 'Sold',
    'Fumbled', 'Bag Secured', 'Generational', 'Aura Farming', 'NPC Behavior',
    'Goofy', 'Zesty', 'Sus', 'Ick', 'Red Flag',
    'Green Flag', 'Valid', 'Invalid', 'Certified', 'Elite'
    ],
    eten: [
        'Pizza', 'Hamburger', 'Pasta', 'Sushi', 'Kebab',
        'Frikandel', 'Kroket', 'Bitterballen', 'Poffertjes', 'Stroopwafel',
        'Pannenkoeken', 'Friet', 'Wrap', 'Döner', 'Taco',
        ...
        'Ramen', 'Naan', 'Dim Sum', 'Dumplings', 'Gyoza',
        'Spring Rolls', 'Pad Thai', 'Tom Yum', 'Green Curry', 'Rendang',
        'Paratha', 'Biryani', 'Tikka Masala', 'Samosa', 'Pakora',
        ...
        'Roti', 'Shepherd Pie', 'Scones', 'Chips', 'Yorkshire Pudding',
    ...
    muziek: [
        ...
        'Eminem', 'Kanye West', 'Jay-Z', 'Tupac', 'BiggieDaggoe',
        'Coldplay', 'Imagine Dragons', 'Maroon 5', 'One Direction', 'Billie Eilish',
        'Rolling Stones', '21 Savage', 'Big Time Rush', 'Nirvana', 'Metallica',
        'AC/DC', 'Guns N Roses', 'Aerosmith', 'Lil Tecca', 'Just Dance',
        'Jukebox', 'Juice World', 'Arctic Monkeys', 'The Strokes', 'Bad Bunny',
        'Drake', 'Bloef', 'Lijpe', 'Fall Out Boy', 'Panic at the Disco',
        'Fatah', 'Linkin Park', 'Kendrick Lamar', 'Mora', 'Riffi',
        'Indila', 'Gimms', 'Lil Baby', 'Soulja Boy', 'Gunna',
        'Lil Uzi', 'XXX Tentacion', 'Hardwell', 'Afrojack', 'Steve Aoki',
        'Skrillex', 'Deadmau5', 'Marshmello', 'Diplo', 'Major Lazer',
        'Post Malone', 'Travis Scott', 'Lil Nas X', 'Doja Cat', 'Megan Thee Stallion',
        'Cardi B', 'Nicki Minaj', 'SZA', 'NEXT', 'Bob Marley'
    ],
    geloof: [
        'Ba7antallah', 'Keppel', 'Prayers', 'Buddha', 'Koe',
        'Moskee', 'Kerk', 'Synagoge', 'Tempel', 'Jezus',
        'Koran', 'Bijbel', 'Torah', 'Mohammed PBUH', 'Idris',
        'Ramadan', 'Pasen', 'Kerstmis', 'Pagwa', 'Divali',
        'Gebed', 'Meditatie', 'Pelgrimage', 'Ceremonie', 'Ritueel',
        'Allah', 'God', 'Jahweh', 'Boeddha', 'Dajjal',
        'Profeet', 'Messias', 'Heilige', 'Monnik', 'Priester',
        'Vasten', 'Offeren', 'Zegen', 'Sacrament', 'Verlichting',
        'Hemel', 'Hel', 'Paradijs', 'Nirvana', 'Sidratul Muntaha',
        'Engel', 'Duivel', 'Demon', 'Geest', 'Ziel',
        'Ibrahim', 'Ismail AS', 'Mozes', 'Abraham', 'Siddharta',
        'Umrah', 'Shiva', 'Krishna', 'Ganesha', 'Lakshmi',
        'Hadj', 'Zakat', 'Salat', 'Shahada', 'Sawm',
        'Doop', 'Sheikh', 'Preek', 'Huwelijk', 'Wijding',
        'Bar Mitswa', 'Jihad', 'Zina', 'Bidah', 'Chanoeka',
    ...
    beroemdheden: [
        ...
        'Elon Musk', 'Jeff Bezos', 'Bill Gates', 'Mark Zuckerberg', 'Jeffrey Epstein',
        'Kim Kardashian', 'Kylie Jenner', 'Kendall Jenner', 'Khloé Kardashian', 'Kourtney Kardashian',
        'Justin Bieber', 'Selena Gomez', 'Miley Cyrus', 'Eiichiro Oda', 'Shawn Mendes',
        'Zendaya', 'Tom Holland', 'Tite Kubo', 'Millie Bobby Brown', 'Billie Eilish',
        'Harry Styles', 'Zayn Malik', 'Kishimoto', 'Chunks', 'Yung Fily',
        ...
        'Usain Bolt', 'Lil Uzi', 'Michael Phelps', 'Pop Smoke', 'KSI',
        'Mufti Menk', 'John Cena', 'Lewis Hamilton', 'Max Verstappen', 'Valentino Rossi',
        'Conor McGregor', 'Khabib Nurmagomedov', 'Mike Tyson', 'Floyd Mayweather', 'Manny Pacquiao',
        'Emma Watson', 'Jennifer Lawrence', 'Scarlett Johansson', 'Margot Robbie', 'Mohamed Ali',
        ...
        'Oprah Winfrey', 'Michael J White', 'M Huncho', 'Lijpe', 'Trevor Noah',
        'MrBeast', 'PewDiePie', 'Logan Paul', 'Jake Paul', 'Donald Trump',
        'Charli Damelio', 'Addison Rae', 'Khaby Lame', 'Eddie Murphy', 'Mandela'
    ]
};
